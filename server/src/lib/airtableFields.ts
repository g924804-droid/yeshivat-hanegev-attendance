...
export const FIELDS = {
  ...
  students: {
    ...
    // מזהי מסלולים), לא "מסלול" יחיד. שדה "תלמידות" בטבלת המסלולים עצמה הוא טקסט מחושב
  ...
  attendance: {
    ...
    status: 'סטטוס נוכחות',
    notes: 'הערות',
    // שדה מקושר קיים לטבלת השיעורים — כך נוכחות משועורים שונים באותו יום (למשל שני שיעורי
    // קודש עם אותה מורה) לא מתערבבת לרשומה אחת.
    lesson: 'כיתה',
    teacher: 'מורה',
  },
  grades: {
